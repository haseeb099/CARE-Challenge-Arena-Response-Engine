        ...
        try {
            ...
            while (choice != 0 ) {
                ...
                if (choice == 1) {
                    ...
                    if (result == 0) {
                        output = "Champion entered into vizier's team";
                    } else if (result == 1) {
                        output = "Champion not in reserve";
                    } else if (result == 2) {
                        output = "Not enough money in the treasury";
                    } else if (result == -1) {
                    ...
                    System.out.println("Enter Champion name");
                    String ref = (myIn.nextLine()).trim();
                    result = tr.retireChampion(ref);
                    if (result == 0) {
                        output = "Champion retired to reserves";
                    } else if (result == 1) {
                        output = "Champion not retired because disqualified";
                    } else if (result == 2) {
                        output = "Champion not retired because not in team";
                    } else if (result == -1) {
                        output = "No such champion";
                    }
                    System.out.println(output);
